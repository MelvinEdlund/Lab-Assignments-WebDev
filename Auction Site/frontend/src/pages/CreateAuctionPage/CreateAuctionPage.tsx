...
export default function CreateAuctionPage() {
  ...
  return (
    <div className="page-center">
      <div className="form-card create-auction-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea
              className="form-control create-auction-textarea"
              value={description}
          ...
          <div className="create-auction-dates">
            <div className="form-group">
          ...
          <div className="create-auction-actions">
            <button
              type="button"
              className="btn btn-ghost create-auction-action-cancel"
              onClick={() => navigate("/")}
            >
              Avbryt
            </button>
            <button
              type="submit"
              className="btn btn-primary create-auction-action-submit"
              disabled={loading}
            >
